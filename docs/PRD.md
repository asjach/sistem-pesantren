...
| Atribut | Keterangan |
|---|---|
| Versi Dokumen | 2.64 (default urut santri) |
...
| 2.64 | 2026-09-17 | Default urut santri = JK lalu Nama ($bawaan + state awal page disamakan); pola default didokumentasikan di backend-detail §8 |
## Daftar Isi
