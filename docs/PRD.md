...
| 2.7 | 2026-09-16 | **Ribbon tidak lagi menggulir horizontal (FE)**: baris tools dibuat membungkus (`flex-wrap`, tinggi ikut tumbuh) alih-alih `overflow-x-auto`; pemilih **Tahap PSB** diringkas jadi dropdown `Select` (label + jumlah) sehingga baris lebih pendek; terverifikasi uji browser di 1360 px & 1120 px (`scrollWidth == clientWidth`, tanpa scroll halaman, ganti tahap via dropdown memunculkan aksi Pendaftar); `typecheck` & `build` lolos |
