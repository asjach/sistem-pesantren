...
export const HALAMAN: HalamanDef[] = [
  ...
  { to: '/riwayat-belajar', label: 'Riwayat Belajar', tab: 'santri', grid: true },
  { to: '/daftar-kelas', label: 'Daftar Kelas', tab: 'santri', grid: true },
  { to: '/pindah-kelas', label: 'Pindah Kelas', tab: 'santri', grid: true },
  { to: '/kenaikan', label: 'Kenaikan Kelas', tab: 'santri', grid: true },
  { to: '/kelulusan', label: 'Kelulusan', tab: 'santri', grid: true },
  { to: '/rekap-santri', label: 'Rekap Santri', tab: 'santri', grid: true },
