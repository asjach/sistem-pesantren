...
export const HALAMAN: HalamanDef[] = [
  ...
  { to: '/daftar-kelas', label: 'Daftar Kelas', tab: 'santri', grid: true },
  { to: '/roster-kelas', label: 'Roster & Pindah Kelas', tab: 'santri', grid: true },
  { to: '/penempatan-kelas', label: 'Penempatan Kelas', tab: 'santri', grid: true },
  { to: '/kenaikan-kelas', label: 'Kenaikan Kelas', tab: 'santri', grid: true },
  { to: '/salin-genap', label: 'Salin Ganjil→Genap', tab: 'santri', grid: true },
  { to: '/rekap-penempatan', label: 'Rekap Penempatan per Kelas', tab: 'santri', grid: true },
  { to: '/mutasi-keluar', label: 'Mutasi Keluar', tab: 'santri', grid: true },
  { to: '/alumni', label: 'Alumni', tab: 'santri', grid: true },
  { to: '/arsip-berhenti', label: 'Arsip Berhenti/Nonaktif', tab: 'santri', grid: true },
