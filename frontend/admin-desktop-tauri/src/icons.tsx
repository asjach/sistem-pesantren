...
import IcCalendarDaysLucide from '~icons/lucide/calendar-days';
import IcCalendarRangeLucide from '~icons/lucide/calendar-range';
import IcCheckLucide from '~icons/lucide/check';
import IcCheckCircle2Lucide from '~icons/lucide/circle-check-big';
import IcChevronDownLucide from '~icons/lucide/chevron-down';
import IcChevronLeftLucide from '~icons/lucide/chevron-left';
import IcChevronRightLucide from '~icons/lucide/chevron-right';
...
import IcPencilLucide from '~icons/lucide/pencil';
...
import IcCalendarDaysTabler from '~icons/tabler/calendar';
import IcCalendarRangeTabler from '~icons/tabler/calendar-week';
import IcCheckTabler from '~icons/tabler/check';
import IcCheckCircle2Tabler from '~icons/tabler/circle-check';
import IcChevronDownTabler from '~icons/tabler/chevron-down';
import IcChevronLeftTabler from '~icons/tabler/chevron-left';
import IcChevronRightTabler from '~icons/tabler/chevron-right';
...
import IcPencilTabler from '~icons/tabler/pencil';
import IcPlusTabler from '~icons/tabler/plus';
...
import IcBookOpenPh from '~icons/ph/book-open';
import IcCalendarCheckPh from '~icons/ph/calendar-check';
import IcCalendarDaysPh from '~icons/ph/calendar';
import IcCalendarRangePh from '~icons/ph/calendar';
import IcCheckPh from '~icons/ph/check';
import IcCheckCircle2Ph from '~icons/ph/check-circle';
import IcChevronDownPh from '~icons/ph/caret-down';
import IcChevronLeftPh from '~icons/ph/caret-left';
...
import IcPencilPh from '~icons/ph/pencil';
...
import IcSunPh from '~icons/ph/sun';
...
import IcWalletPh from '~icons/ph/wallet';
import IcXPh from '~icons/ph/x';
import IcXCirclePh from '~icons/ph/x-circle';
import IcChevronUpPh from '~icons/ph/caret-up';
import IcCircleCheckPh from '~icons/ph/check-circle';
...
import IcCalendarRangeHeroicons from '~icons/heroicons/calendar';
import IcCheckHeroicons from '~icons/heroicons/check';
import IcCheckCircle2Heroicons from '~icons/heroicons/check-circle';
import IcChevronDownHeroicons from '~icons/heroicons/chevron-down';
import IcChevronLeftHeroicons from '~icons/heroicons/chevron-left';
import IcChevronRightHeroicons from '~icons/heroicons/chevron-right';
import IcClipboardCheckHeroicons from '~icons/heroicons/clipboard-document-check';
...
import IcGraduationCapHeroicons from '~icons/heroicons/academic-cap';
...
import IcPlusHeroicons from '~icons/heroicons/plus';
...
import IcSunHeroicons from '~icons/heroicons/sun';
...
import IcXHeroicons from '~icons/heroicons/x-mark';
import IcXCircleHeroicons from '~icons/heroicons/x-circle';
import IcChevronUpHeroicons from '~icons/heroicons/chevron-up';
...
import IcCalendarDaysRi from '~icons/ri/calendar-line';
import IcCalendarRangeRi from '~icons/ri/calendar-2-line';
import IcCheckRi from '~icons/ri/check-line';
import IcCheckCircle2Ri from '~icons/ri/checkbox-circle-line';
import IcChevronDownRi from '~icons/ri/arrow-down-s-line';
import IcChevronLeftRi from '~icons/ri/arrow-left-s-line';
import IcChevronRightRi from '~icons/ri/arrow-right-s-line';
...
import IcPencilRi from '~icons/ri/pencil-line';
import IcPlusRi from '~icons/ri/add-line';
...
import IcServerRi from '~icons/ri/server-line';
import IcSunRi from '~icons/ri/sun-fill';
...
import IcWalletRi from '~icons/ri/wallet-line';
import IcXRi from '~icons/ri/close-line';
import IcXCircleRi from '~icons/ri/close-circle-line';
...
import IcCalendarDaysIconoir from '~icons/iconoir/calendar';
import IcCalendarRangeIconoir from '~icons/iconoir/calendar';
import IcCheckIconoir from '~icons/iconoir/check';
import IcCheckCircle2Iconoir from '~icons/iconoir/check-circle';
import IcChevronDownIconoir from '~icons/iconoir/nav-arrow-down';
import IcChevronLeftIconoir from '~icons/iconoir/nav-arrow-left';
import IcChevronRightIconoir from '~icons/iconoir/nav-arrow-right';
...
import IcMoonIconoir from '~icons/iconoir/half-moon';
import IcMoreVerticalIconoir from '~icons/iconoir/more-vert';
import IcNotebookTabsIconoir from '~icons/iconoir/journal-page';
import IcPaletteIconoir from '~icons/iconoir/palette';
import IcPencilIconoir from '~icons/iconoir/edit';
import IcPlusIconoir from '~icons/iconoir/plus';
...
import IcServerIconoir from '~icons/iconoir/server';
import IcSunIconoir from '~icons/iconoir/brightness';
...
import IcXCircleIconoir from '~icons/iconoir/xmark-circle';
import IcChevronUpIconoir from '~icons/iconoir/nav-arrow-up';
...
import IcCheckRadix from '~icons/radix-icons/check';
import IcCheckCircle2Radix from '~icons/radix-icons/check-circled';
import IcChevronDownRadix from '~icons/radix-icons/chevron-down';
import IcChevronLeftRadix from '~icons/radix-icons/chevron-left';
...
import IcCalendarDaysBi from '~icons/bi/calendar';
import IcCalendarRangeBi from '~icons/bi/calendar-range';
import IcCheckBi from '~icons/bi/check';
import IcCheckCircle2Bi from '~icons/bi/check-circle';
import IcChevronDownBi from '~icons/bi/chevron-down';
import IcChevronLeftBi from '~icons/bi/chevron-left';
import IcChevronRightBi from '~icons/bi/chevron-right';
...
import IcPencilBi from '~icons/bi/pencil';
...
import IcServerBi from '~icons/bi/server';
import IcSunBi from '~icons/bi/sun';
...
import IcBookOpenMaterial from '~icons/material-symbols/book';
import IcCalendarCheckMaterial from '~icons/material-symbols/calendar-check';
import IcCalendarDaysMaterial from '~icons/material-symbols/calendar-month';
import IcCalendarRangeMaterial from '~icons/material-symbols/date-range';
import IcCheckMaterial from '~icons/material-symbols/check';
import IcCheckCircle2Material from '~icons/material-symbols/check-circle';
import IcChevronDownMaterial from '~icons/material-symbols/expand-more';
import IcChevronLeftMaterial from '~icons/material-symbols/chevron-left';
import IcChevronRightMaterial from '~icons/material-symbols/chevron-right';
...
import IcPencilMaterial from '~icons/material-symbols/edit';
import IcPlusMaterial from '~icons/material-symbols/add';
...
const SET: Record<IconSetId, Record<string, IkonDasar>> = {
  lucide: {
    ...
    CalendarDays: IcCalendarDaysLucide,
    CalendarRange: IcCalendarRangeLucide,
    Check: IcCheckLucide,
    CheckCircle2: IcCheckCircle2Lucide,
    ChevronDown: IcChevronDownLucide,
    ChevronLeft: IcChevronLeftLucide,
    ChevronRight: IcChevronRightLucide,
  ...
  tabler: {
    ...
    CalendarDays: IcCalendarDaysTabler,
    CalendarRange: IcCalendarRangeTabler,
    Check: IcCheckTabler,
    CheckCircle2: IcCheckCircle2Tabler,
    ChevronDown: IcChevronDownTabler,
    ChevronLeft: IcChevronLeftTabler,
    ChevronRight: IcChevronRightTabler,
  ...
  ph: {
    ...
    BookOpen: IcBookOpenPh,
    CalendarCheck: IcCalendarCheckPh,
    CalendarDays: IcCalendarDaysPh,
    CalendarRange: IcCalendarRangePh,
    Check: IcCheckPh,
    CheckCircle2: IcCheckCircle2Ph,
    ChevronDown: IcChevronDownPh,
    ChevronLeft: IcChevronLeftPh,
    ...
    X: IcXPh,
    XCircle: IcXCirclePh,
    ChevronUp: IcChevronUpPh,
    CircleCheck: IcCircleCheckPh,
    Info: IcInfoPh,
    Loader2: IcLoader2Ph,
  ...
  heroicons: {
    ...
    CalendarRange: IcCalendarRangeHeroicons,
    Check: IcCheckHeroicons,
    CheckCircle2: IcCheckCircle2Heroicons,
    ChevronDown: IcChevronDownHeroicons,
    ChevronLeft: IcChevronLeftHeroicons,
    ChevronRight: IcChevronRightHeroicons,
    ClipboardCheck: IcClipboardCheckHeroicons,
    ...
    GraduationCap: IcGraduationCapHeroicons,
    ...
    X: IcXHeroicons,
    XCircle: IcXCircleHeroicons,
    ChevronUp: IcChevronUpHeroicons,
  ...
  ri: {
    ...
    CalendarDays: IcCalendarDaysRi,
    CalendarRange: IcCalendarRangeRi,
    Check: IcCheckRi,
    CheckCircle2: IcCheckCircle2Ri,
    ChevronDown: IcChevronDownRi,
    ChevronLeft: IcChevronLeftRi,
    ChevronRight: IcChevronRightRi,
  ...
  iconoir: {
    ...
    CalendarDays: IcCalendarDaysIconoir,
    CalendarRange: IcCalendarRangeIconoir,
    Check: IcCheckIconoir,
    CheckCircle2: IcCheckCircle2Iconoir,
    ChevronDown: IcChevronDownIconoir,
    ChevronLeft: IcChevronLeftIconoir,
    ChevronRight: IcChevronRightIconoir,
    ...
    Moon: IcMoonIconoir,
    MoreVertical: IcMoreVerticalIconoir,
    NotebookTabs: IcNotebookTabsIconoir,
    Palette: IcPaletteIconoir,
    Pencil: IcPencilIconoir,
    Plus: IcPlusIconoir,
    ...
    X: IcXIconoir,
    XCircle: IcXCircleIconoir,
    ChevronUp: IcChevronUpIconoir,
  ...
  radix: {
    ...
    Check: IcCheckRadix,
    CheckCircle2: IcCheckCircle2Radix,
    ChevronDown: IcChevronDownRadix,
    ChevronLeft: IcChevronLeftRadix,
  ...
  bi: {
    ...
    CalendarDays: IcCalendarDaysBi,
    CalendarRange: IcCalendarRangeBi,
    Check: IcCheckBi,
    CheckCircle2: IcCheckCircle2Bi,
    ChevronDown: IcChevronDownBi,
    ChevronLeft: IcChevronLeftBi,
    ChevronRight: IcChevronRightBi,
  ...
  material: {
    ...
    BookOpen: IcBookOpenMaterial,
    CalendarCheck: IcCalendarCheckMaterial,
    CalendarDays: IcCalendarDaysMaterial,
    CalendarRange: IcCalendarRangeMaterial,
    Check: IcCheckMaterial,
    CheckCircle2: IcCheckCircle2Material,
    ChevronDown: IcChevronDownMaterial,
    ChevronLeft: IcChevronLeftMaterial,
    ChevronRight: IcChevronRightMaterial,
