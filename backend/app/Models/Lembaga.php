...
class Lembaga extends Model
{
    ...
    protected $fillable = ['parent_id', 'nama', 'nama_singkat', 'kode', 'mudir_am', 'jenjang', 'status', 'npsn', 'nsm', 'npwp', 'no_izin_operasional', 'tgl_izin', 'no_sk_pendirian', 'tgl_sk_pendirian', 'tahun_berdiri', 'no_sk_kemenkumham', 'akreditasi', 'tgl_akreditasi', 'penyelenggara', 'provinsi', 'kab_kota', 'kecamatan', 'desa', 'rt', 'rw', 'kode_pos', 'alamat', 'lintang', 'bujur', 'telepon', 'email', 'website', 'logo_url', 'waktu_belajar', 'mode_rapor', 'template_rapor', 'psb_butuh_seleksi_default', 'kelompok_psb', 'is_active'];
    protected $casts = ['tgl_izin' => 'date', 'tgl_sk_pendirian' => 'date', 'tgl_akreditasi' => 'date', 'lintang' => 'decimal:7', 'bujur' => 'decimal:7', 'psb_butuh_seleksi_default' => 'boolean', 'is_active' => 'boolean'];

    public function parent() { return $this->belongsTo(Lembaga::class, 'parent_id'); }
    public function children() { return $this->hasMany(Lembaga::class, 'parent_id'); }
